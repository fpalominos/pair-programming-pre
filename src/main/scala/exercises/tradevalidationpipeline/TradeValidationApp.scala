...
object TradeValidationApp extends App {
  ...
  val trades1 = Seq(
    Trade(id = "1", symbol = Some("s1"), quantity = 2, price = 10),
    Trade(id = "1", symbol = Some("s1"), quantity = 2, price = 10)
  )

  val trades2 = Seq(
    Trade(id = "1", symbol = Some("s1"), quantity = -2, price = -10),
    Trade(id = "2", symbol = Some("s2"), quantity = 2, price = 10),
    Trade(id = "3", symbol = Some(""), quantity = -4, price = 3),
  )

  val trades3 = Seq(
    Trade(id = "1", symbol = Some("s1"), quantity = 2, price = 10),
    Trade(id = "2", symbol = Some("s2"), quantity = 3, price = 11),
  )
